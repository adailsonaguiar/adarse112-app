...
function Offers() {
  ...
  return (
    <SectionWrapper title="DÍZIMOS E OFERTAS" style="bg-neutral-200 pt-20">
      {/* <S.Container> */}
      {/* <ContentWrapper> */}
      <div className="flex w-full justify-center px-10">
        <div className="grid md:grid-cols-2 w-full md:w-7/12">
          ...
          <div className="flex flex-col items-center mb-16">
            <h3 className="font-bold text-4xl mb-10 text-center">
