...
export const OptionCard = ({ label = "", link }) => {
  ...
  return (
    <Link href={link} passHref>
      <div className="flex flex-col items-center justify-center gap-3 rounded-xl text-white px-16 md:px-20 py-10 tracking-widest font-medium text-xl md:text-2xl bg-white/10 hover:bg-white hover:text-madureira-700 cursor-pointer text-center">
